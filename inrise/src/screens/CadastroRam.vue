<template>
    <div class="cadastrar-produtos">
      <h1>Cadastrar Produto - Memória RAM</h1>
      <p>Preencha os campos abaixo para cadastrar uma memória RAM.</p>
      ...
      <form @submit.prevent="submitForm" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="form-group">
          ...
          <input 
            type="number" 
            v-model="formData.price.costPrice" 
            id="costPrice" 
            required 
            class="w-full border p-2" 
          />
        ...
        <div class="form-group">
          ...
          <input 
            type="number" 
            v-model="formData.price.porcentageProfit" 
            id="porcentageProfit" 
            required 
            class="w-full border p-2" 
          />
        ...
        <div class="form-group">
          ...
          <input 
            type="number" 
            v-model="formData.price.porcentageFixedCost" 
            id="porcentageFixedCost" 
            required 
            class="w-full border p-2" 
          />
        </div>
        ...
        <div class="form-group">
          ...
          <input 
            type="number" 
            v-model="formData.price.porcentageADMCost" 
            id="porcentageADMCost" 
            required 
            class="w-full border p-2" 
          />
        </div>
        ...
        <div class="form-group">
          ...
          <input 
            type="number" 
            v-model="formData.price.porcentageDiscount" 
            id="porcentageDiscount" 
            required 
            class="w-full border p-2" 
          />
        </div>
        ...
        <div class="form-group">
          ...
          <input 
            type="number" 
            v-model="formData.price.subtotal" 
            id="subtotal" 
            required 
            class="w-full border p-2" 
          />
        ...
        <div class="form-group">
          ...
          <input 
            type="number" 
            v-model="formData.price.finalPrice" 
            id="finalPrice" 
            required 
            class="w-full border p-2" 
          />
