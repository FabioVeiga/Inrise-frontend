...
>>>>>>> 554b403ba4cb801d05e1f534f77e3493d6196ca5
        ...
        <div class="col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="form-group">
            ...
            <input
              type="number"
              v-model="formData.velocityWrite"
              id="velocityWrite"
              required
              class="w-full border p-2"
            />
