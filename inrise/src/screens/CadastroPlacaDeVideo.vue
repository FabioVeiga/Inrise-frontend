<template>
  <div class="cadastrar-produto my-5">
    <form @submit.prevent="submitForm" class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <InfoGeral :formData="formData" @update-form-data="updateFormData" :product-type="'videoBoard'" />
      ...
      <div class="col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="form-group">
          ...
          <input type="number" v-model="formData.bits" id="bits" required class="w-full border p-2" />
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" v-model="formData.dimension" id="dimension" required class="w-full border p-2" />
        </div>
...
import { registerGPU, registerImage } from '@/api';
