  ...
  <nav class="home-menu">
    <ul>
      ...
      <li :class="{ 'active': activeTab === 'perifericos' }">
        <a @click="changeTab('perifericos')">PERIFÉRICOS</a>
      </li>
      <li :class="{ 'active': activeTab === 'sac' }">
        <a @click="changeTab('sac')">SAC</a>
      </li>
      <li :class="{ 'active': activeTab === 'quem-somos' }">
        <a @click="changeTab('quem-somos')">QUEM SOMOS</a>
      </li>
    </ul>
  </nav>
</template>
