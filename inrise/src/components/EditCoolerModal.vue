<template>
  <div class="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center z-50" @click.self="closeModal">
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md h-[80vh] overflow-y-auto relative">
      <button @click="closeModal" class="absolute top-2 right-2 text-gray-500 hover:text-gray-700 text-xl" aria-label="Fechar Modal">
        &times;
      </button>
      ...
      <form @submit.prevent="submitForm" class="grid grid-cols-1 gap-4">
        ...
        <div class="col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="form-group">
            ...
            <input
              type="text"
              v-model="editedProduct.refrigeration"
              id="refrigeration"
              required
              class="w-full border p-2"
            />
          ...
          <div class="form-group">
            ...
            <input
              type="number"
              v-model="editedProduct.fanQuantity"
              id="fanQuantity"
              required
              class="w-full border p-2"
            />
          ...
          <div class="form-group">
            ...
            <input
              type="number"
              v-model="editedProduct.fanDiametric"
              id="fanDiametric"
              required
              class="w-full border p-2"
            />
          ...
          <div class="form-group">
            ...
            <input
              type="number"
              v-model="editedProduct.maxVelocit"
              id="maxVelocit"
              required
              class="w-full border p-2"
            />
          ...
          <div class="form-group">
            ...
            <input
              type="number"
              v-model="editedProduct.dimension"
              id="dimension"
              required
              class="w-full border p-2"
            />
...
<script>
import { editCooler } from '@/api'; // Certifique-se de ter essa função na sua API
