  ...
  <div class="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center z-50" @click.self="closeModal">
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md h-[80vh] overflow-y-auto relative">
      ...
      <form @submit.prevent="submitForm" class="grid grid-cols-1 gap-4">
        ...
        <InfoGeral :form-data="editedProduct" @update-form-data="updateFormData" :product-type="'powerSupply'" />
        ...
        <div class="col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="form-group">
            ...
            <input type="number" v-model="editedProduct.potencyReal" id="potencyReal" required
          ...
          <div class="form-group">
            ...
            <input type="checkbox" v-model="editedProduct.modular" id="modular" class="w-full border p-2" />
          </div>
        </div>
...
<script>
import { editPsu, registerImage } from '@/api';
